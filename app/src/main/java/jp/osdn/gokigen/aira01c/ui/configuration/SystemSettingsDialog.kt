        ...
        try
        {
            ...
            val thread = Thread {
                try
                {
                    ...
                    val body = "<?xml version=\"1.0\"?><desclist><prop name=\"WIFI_CH\"/><prop name=\"SLEEP\"/><prop name=\"SOUND_VOLUME_LEVEL\"/><prop name=\"LENS_RESET\"/><prop name=\"IMAGESIZE\"/><prop name=\"COMPRESSIBILITY_RATIO\"/><prop name=\"RAW\"/>"
