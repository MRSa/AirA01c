...
class OmdsCommPathStatus(private val activity: FragmentActivity, private val messageDrawer: IMessageDrawer, userAgent: String = "OlympusCameraKit", private val executeUrl : String = "http://192.168.0.10")
{
    private val headerMap: MutableMap<String, String> = HashMap()
    private val http = SimpleHttpClient()

    fun getCommPathStatus(callback: IOmdsOperationCallback?)
    {
        try
        {
            ...
            val thread = Thread {
                ...
                val message = "${activity.getString(R.string.camera_communication_path)} ${pickupValue("path", response)}\n"
